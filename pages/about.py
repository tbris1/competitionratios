...
layout = dbc.Card([
    ...
    dbc.CardBody([
        html.P(""),
        html.H5("What is this?", className="mt-4", style={"fontStyle": "italic"}),
        html.P(
            "It's basically just a fancy graph. "
        ),
        html.H5("But why?", className="mt-4", style={"fontStyle": "italic"}),
        html.P(
            "This site has been created primarily to demonstrate the trends in competition for a UK specialty training place "
            "and make visualising the data easier than reading through tables on separate NHS webpages. "
            "It has not been designed to make any political points, nor has it been designed to influence career choices."
        ),
        html.P(
